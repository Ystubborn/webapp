...
export const OrderService = (opt, met, res) => {
    if (met == "GET") {
        ...
        return axios(`/api/OrderService/${opt}`, { method: met, res })
    }
}
//报价
export const Quotation = (opt, met, res) => {
    if (met == "GET") {
        ...
        return axios(`/api/Quotation/${opt}`, { method: met, res })
    }
}
//团队
export const Team = (opt, met, res) => {
    if (met == "GET") {
        ...
        return axios(`/api/Team/${opt}`, { method: met, res })
    }
}
//钱包
export const Wallet = (opt, met, res) => {
    if (met == "GET") {
        ...
        return axios(`/api/Wallet/${opt}`, { method: met, res })
    }
}
