<template>
  <div class="login">
    <el-form :model="loginForm" :rules="rules" class="panel" ref="loginForm" label-width="0">
      <el-form-item prop="name">
        <el-input v-model="loginForm.userAccount" prefix-icon="el-icon-user" placeholder="账号" type="text"></el-input>
      </el-form-item>
